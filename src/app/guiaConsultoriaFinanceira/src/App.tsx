...
import DiagnosticoFinanceiro from './components/DiagnosticoFinanceiro'
import DiagnosticoEmpresarial from './components/DiagnosticoEmpresarial'
import FluxoCaixaEmpresarial from './components/FluxoCaixaEmpresarial'
import OrcamentoPessoal from './components/OrcamentoPessoal'
import Capa from './components/Capa'
import CapaPF from './components/CapaPF'
import CapaPJ from './components/CapaPJ'
      ...
      <div className="bg-gray-800 text-white py-8 mt-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400">
            Metodologia prática para consultores financeiros
          </p>
        </div>
      </div>
    </div>
